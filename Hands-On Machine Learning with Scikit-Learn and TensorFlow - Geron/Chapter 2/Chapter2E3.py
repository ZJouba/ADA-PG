...
def index_of_mostimportant(arr, i):
...
random_search = RandomizedSearchCV(supportVectorM, param_random, n_iter = 10, cv=5, scoring='neg_mean_squared_error', verbose=1, n_jobs=4, pre_dispatch=2*n_jobs)                           # have to keep this here to determine feature importances?
...
fuller_pipeline = Pipeline([
    ('preparation', full_pipeline),
    ('importantfeaturesonly', MostImportantFeatures(feature_importances, i)),
])

housing_prepared_fuller = fuller_pipeline.fit_transform(housing)